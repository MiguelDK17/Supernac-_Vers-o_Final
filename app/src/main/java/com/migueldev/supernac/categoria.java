    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Jogos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(getApplicationContext(), com.migueldev.supernac.Jogos.class);
                startActivity(it);
            }
        });
        ...
        Informatica.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent info = new Intent(getApplicationContext(), com.migueldev.supernac.Informatica.class);
                startActivity(info);
            }
        });
        ...
        Hortifruti.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent fruit = new Intent(getApplicationContext(), com.migueldev.supernac.Hortifruti.class);
                startActivity(fruit);
            }
        });
        Padaria.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cupcake = new Intent(getApplicationContext(), com.migueldev.supernac.Padaria.class);
